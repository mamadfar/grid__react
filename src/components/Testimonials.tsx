            ...
            <div className="testimonials">
                <div className="card card--bg-purple">
                    <header className="card__header">
                        <img src="src/assets/img/image-daniel.jpg" alt="Daniel" className="card__img"/>
                        <div>
                ...
                <div className="card card--bg-gray-blue">
                    <header className="card__header">
                        <img src="src/assets/img/image-jonathan.jpg" alt="Jonathan" className="card__img"/>
                        <div>
                ...
                <div className="card card--bg-red">
                    <header className="card__header">
                        <img src="src/assets/img/image-jeanette.jpg" alt="Jeanette" className="card__img"/>
                        <div>
                ...
                <div className="card card--bg-black-blue">
                    <header className="card__header">
                        <img src="src/assets/img/image-patrick.jpg" alt="Patrick" className="card__img"/>
                        <div>
                    ...
                    <p className="card__quote">
                        ...
                        from an incredible community of people. ”
                    </p>
                </div>
                <div className="card card--bg-green">
                    <header className="card__header">
                        <img src="src/assets/img/image-kira.jpg" alt="Kira" className="card__img"/>
                        <div>
                            <h3>Kira Whittle</h3>
                            <p>Verified Graduate</p>
                        </div>
                    ...
                    <p className="card__quote">
                        ...
                        The agile team project, in particular, was outstanding. It took my learning to the next level in
                        a
                        way that no tutorial could ever have. In fact, I’ve often referred to it during interviews as an
                        example of my development experience. It certainly helped me land a job as a full-stack
                        developer
